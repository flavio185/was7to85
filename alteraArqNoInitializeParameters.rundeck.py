cat <<EOF >/var/tmp/alteraInitializeArq.py
...
chmod 777 /var/tmp/alteraInitializeArq.py

sudo su - websphere -c "
  /opt/WebSphere8.5.5/AppServer/profiles/Dmgr01/bin/wsadmin.sh -lang jython -f /var/tmp/alteraInitializeArq.py
"

rm -rf /var/tmp/alteraInitializeArq.py